...
bd_pdm_mapa %>% 
  ...
  geom_sf_text(aes(label = siglas), color = "white", size = 1.5, fontface = "bold") +
  theme_minimal() +
...
o_c_mapa %>%
  ...
  geom_sf_text(aes(label = sigla), color = "white", size = 1.5, fontface = "bold") + 
  theme_minimal() +
...
ref_idrgp$sp_nome <- subprefeitura$sp_nome
